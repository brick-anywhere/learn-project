package com.dll.common.redis.template;
...
public class StringRedisUtil {
    ...
    public StringRedisUtil(RedisTemplate<String, Object> redisTemplate) {
    ...
    public void setExpire(final String key, final Object value, final long time) {
        redisTemplate.execute((RedisCallback<Long>) connection -> {
            ...
            LogUtil.info("[redisTemplate redis]放入 缓存  url:{} ========缓存时间为{}秒,{}", key, time, f);
            return 1L;
        });
    }
    ...
    public Set<String> scan(final String keyPattern) {
        Set<String> keys = redisTemplate.execute((RedisCallback<Set<String>>) connection -> {
            ...
            Cursor<byte[]> cursor = connection.scan(new ScanOptions.ScanOptionsBuilder().match( keyPattern + "*").count(1000).build());
    ...
    public Long setLoginByLua(String completeKey, String bitmapKey, String value, Integer loginCount) {
        ...
        LogUtil.info("登录统计，KEY：{}，人数：{}",bitmapKey,count);
