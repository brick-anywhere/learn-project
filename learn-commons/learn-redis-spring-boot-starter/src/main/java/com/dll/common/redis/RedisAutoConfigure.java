package com.dll.common.redis;

import com.dll.common.redis.template.StringRedisUtil;
import com.dll.common.redis.properties.CacheManagerProperties;
import com.dll.common.redis.util.RedisObjectSerializer;
 ...
 *
 */
@ConditionalOnClass(StringRedisUtil.class)
...
public class RedisAutoConfigure {
    ...
    public StringRedisUtil redisRepository(RedisTemplate<String, Object> redisTemplate) {
        return new StringRedisUtil(redisTemplate);
    }
